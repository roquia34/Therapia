...
export class TrainerTeamComponent {
  ...
  trainers = [
    ...
    { image: 'recoveryDoctors/doctor7.jpg', name: 'Dr. Sara Hassan', description: 'althcare discipline focused on improving movement ' },
    { image: 'recoveryDoctors/doctor2.jpg', name: 'Dr. Mohmed Hassan', description: 'Affiliation: Washington University in St. Louis Contributions:Dr. Shirley Sahrmann is a pioneer in movement science and rehabilitation. She developed the Movement System Impairment (MSI) syndromes, which help diagnose and treat musculoskeletal disorders based on movement patterns ' }, 
    { image: 'recoveryDoctors/doctor2.jpg', name: 'Dr. Mohmed Hassan', description: 'Affiliation: Washington University in St. Louis Contributions:Dr. Shirley Sahrmann is a pioneer in movement science and rehabilitation. She developed the Movement System Impairment (MSI) syndromes, which help diagnose and treat musculoskeletal disorders based on movement patterns ' }, 

    { image: 'recoveryDoctors/doctor8.jpg', name: 'Dr. Eman Mohmed', description: 'Expertise: Movement System Impairment (MSI) SyndromesAffiliation: Washington University in St. LouisContributions:Dr. Shirley Sahrmann is a pioneer in movement science, known for her work in Movement System Impairment (MSI) Syndromes. Her research focuses on diagnosing and treating musculoskeletal disorders by identifying faulty movement patterns.' },
    { image: 'recoveryDoctors/doctor7.jpg', name: 'Dr. Sara Hassan', description: 'Expertise: Orthopedic & Manual TherapyAffiliation: University of St. Augustine for Health Sciences Contributions:Dr. Catherine Patla is a respected leader in manual therapy and orthopedic physical therapy. She has played a major role in developing advanced treatment techniques for spinal dysfunction, joint mobilization, and soft tissue therapy.' },
    { image: 'recoveryDoctors/doctor4.jpg', name: 'Dr. Adel Mohmed', description: ' Expertise: Geriatric Physical Therapy & Rehabilitation Affiliation: American Physical Therapy Association (APTA)Contributions:Dr. Jennifer Bottomley is a leading expert in geriatric physical therapy, focusing on rehabilitation for older adults. She has helped develop treatment strategies for fall prevention, mobility training, and chronic pain management in elderly populations.' },
